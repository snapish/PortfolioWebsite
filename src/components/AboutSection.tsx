export default function AboutSection() {
  return (
    <section className="content-island" id="about">
      <div>
        ...
        <h2>What software?</h2>
        <p>
            In my free time I experiment with a lot of game engines. I've completed and published a game in the Godot engine, and spent 
            hundreds of hours in Unreal Engine, though I've never 'finished' a project in it. I've taken online courses offered through Udemy on 
            procedural animation in UE5, and a general development course in C# for Unity. Game development will always be a passion of mine.
        <br/>
            As a developer I've worked with an array of frameworks, apps, and languages. All of the noteworthy ones can be found
            on my resume, but I am confident in my ability to pick up any language or framework and use it to its fullest potential. 
        </p>
        <br/>
